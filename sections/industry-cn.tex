...
\textbf{muBLAS} \\[3.75pt]
\multicolumn{2}{@{}X@{}}{muBLAS 是摩尔线程自主研发的 GPU 基础线性代数算子库（对标 NVIDIA cuBLAS）。期间参与了多项核心矩阵运算 API 的设计与开发，包括批处理矩阵 LU 分解 \mintinline{cpp}{getrfBatched}、批处理线性方程组求解 \mintinline{cpp}{getrsBatched}、以及批处理矩阵求逆 \mintinline{cpp}{getriBatched} 和 \mintinline{cpp}{matinvBatched}。}  \\
